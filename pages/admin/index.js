    ...
    <div>
      ...
      <form onSubmit={createPost} className={styles["create-post"]}>
        ...
        <input
          ...
          onChange={(e) => {
            e.preventDefault();
            if (e.currentTarget.checked) setPostType("solution-hub");
          }}
          id="contactChoice1"
          name="postType"
          value="solution-hub"
        ...
        <input
          ...
          onChange={(e) => {
            e.preventDefault();
            if (e.currentTarget.checked) setPostType("knowledge-hub");
          }}
          id="contactChoice1"
          name="postType"
          value="knowledge-hub"
        ...
        <input
          ...
          onChange={(e) => {
            e.preventDefault();
            if (e.currentTarget.checked) setPostType("problems-hub");
          }}
          id="contactChoice1"
          name="postType"
          value="problems-hub"
